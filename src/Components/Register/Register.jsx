        ...
        <>
            <div className="container my-5">
                ...
                <form className='mx-auto' onSubmit={formik.handleSubmit}>
                    ...
                    {isLoading ? <button className='btn bg-outline-danger text-white'> <i className='fa fa-spin fa-spinner px-2'></i> </button> : <button disabled={!(formik.isValid && formik.dirty)} type='submit' className='btn btn-outline-info text-white'> {isLoading ? <i className='fa fa-spin fa-spinner'></i> : 'Register'} </button>}
